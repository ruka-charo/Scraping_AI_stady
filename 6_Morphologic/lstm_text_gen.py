...
#%% １文字ずつバラバラにして文字にIDを振る
chars = sorted(list(set(text)))
print('使われている文字の数:', len(chars))
chars_indices = dict((c, i) for i, c in enumerate(chars)) # 文字 -> ID
...
for iteration in range(1, 60):
    ...
    for diversity in [0.2, 0.5, 1.0, 1.2]:
        ...
        print('---多様性=', diversity)
        generated = ''
        sectence = text[start_index: start_index + maxlen]
        generated += sentence
        print('---シード="' + sentence + '"')
